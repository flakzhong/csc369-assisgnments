...
# Copy
cp images/emptydisk.img A4-self-test/runs/case1-cp.img
cp images/emptydisk.img A4-self-test/runs/case2-cp-large.img
cp A4-self-test/images/removed.img A4-self-test/runs/case3-cp-rm-dir.img

# Mkdir
cp images/emptydisk.img A4-self-test/runs/case4-mkdir.img
cp images/onedirectory.img A4-self-test/runs/case5-mkdir-2.img

# Link
cp images/twolevel.img A4-self-test/runs/case6-ln-hard.img
cp images/twolevel.img A4-self-test/runs/case7-ln-soft.img
...
cp images/largefile.img A4-self-test/runs/case11-rm-large.img
...
# Checker
cp images/twolevel-corrupt.img A4-self-test/runs/case15-checker.img
...
do
	...
	echo "diff A4-self-test/results/$g.txt A4-self-test/solution-results/$g.txt"
	diff A4-self-test/results/$g.txt A4-self-test/solution-results/$g.txt
done
